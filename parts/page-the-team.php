				...
				<div class="row g-0">
					<div class="col-md-3" style="background: #fff;">
						<figure class="figure text-center">
							<img src="<?php echo the_field('team1');?>" class="img-fluid figure-img" alt="<?php echo the_field('team_1_img_alt'); ?>" />
							<figcaption class="figure-caption"><?php echo the_field('emp_title1'); ?></figcaption>
						</figure>
					</div>
